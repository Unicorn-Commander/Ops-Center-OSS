    ...
    <tr><td align="center">
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#ffffff;border:1px solid #ececf0;border-radius:12px;">
        ...
        <tr><td style="padding:8px 32px 0;font-size:15px;line-height:1.6;">
          ...
          <p style="margin:0 0 14px;">We received a request to reset the password for your Unicorn Commander account. Choose a new password using the button below.</p>
        </td></tr>
        <tr><td align="center" style="padding:24px 32px;">
          <a href="${link}" style="background:#6d28d9;color:#ffffff;text-decoration:none;padding:13px 30px;border-radius:8px;font-size:15px;font-weight:600;display:inline-block;">Reset password</a>
        </td></tr>
        <tr><td style="padding:0 32px;font-size:13px;line-height:1.6;color:#6b6b76;">
          ...
          <p style="margin:0 0 10px;">If you didn't request a password reset, you can ignore this email &mdash; your password won't change.</p>
        </td></tr>
