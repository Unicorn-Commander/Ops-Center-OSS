    ...
    <tr><td align="center">
      <table role="presentation" width="520" cellpadding="0" cellspacing="0" style="max-width:520px;width:100%;background:#ffffff;border:1px solid #ececf0;border-radius:12px;">
        ...
        <tr><td style="padding:8px 32px 0;font-size:15px;line-height:1.6;">
          ...
          <p style="margin:0 0 14px;">To finish setting up your account, please complete the following<#if requiredActions?? && requiredActions?size gt 1> steps</#if>:</p>
          <ul style="margin:0 0 4px;padding-left:20px;">
            <#if requiredActions??><#list requiredActions as reqActionItem>
            <li style="margin:4px 0;">${msg("requiredAction." + reqActionItem)}</li>
            </#list></#if>
          </ul>
        </td></tr>
        <tr><td align="center" style="padding:24px 32px;">
          <a href="${link}" style="background:#6d28d9;color:#ffffff;text-decoration:none;padding:13px 30px;border-radius:8px;font-size:15px;font-weight:600;display:inline-block;">Continue</a>
        </td></tr>
        <tr><td style="padding:0 32px;font-size:13px;line-height:1.6;color:#6b6b76;">
          ...
          <p style="margin:0 0 10px;">If you weren't expecting this, you can safely ignore this email and nothing will change.</p>
        </td></tr>
