                        ...
                        <div id="kc-content">
                            <div id="kc-content-wrapper">
                                <div class="alert alert-info uc1-alert">
                                    ...
                                    <span class="kc-feedback-text">${msg("confirmLinkIdpTitle")}</span>
                                </div>

                                <p style="color: var(--uc1-text-secondary); font-size: 14px; line-height: 1.6; margin-bottom: 24px; text-align: center;">
                                    ${msg("confirmLinkIdpReviewProfile", idpDisplayName!idpAlias, brokerContext.username)}
                                </p>

                                <form id="kc-register-form" action="${url.loginAction}" method="post" class="uc1-form">
                                    <div id="kc-form-buttons" class="form-group uc1-button-group" style="display: flex; flex-direction: column; gap: 12px;">
                                        <button type="submit" class="btn btn-primary btn-block btn-lg uc1-submit-btn"
                                                name="submitAction" id="linkAccount" value="linkAccount">
