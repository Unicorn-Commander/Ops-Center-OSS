...
**Last Backup**: Check `/opt/backups/database/`
...
# Or run in container
docker exec ops-center-direct bash -c "cd /app && export POSTGRES_PASSWORD='your-postgres-password' && alembic current"
```
