...
DB_PASSWORD = os.getenv("POSTGRES_PASSWORD", "REDACTED_POSTGRES_PASSWORD")
...
async def create_test_users():
    ...
    try:
        ...
        credentials_file = "/home/muut/Production/UC-Cloud/services/ops-center/backend/tests/test_users.json"
