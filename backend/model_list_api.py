...
class ModelListResponse(BaseModel):
    ...
    app_identifier: Optional[str] = None  # global lists have no app binding
    is_default: bool
    is_active: bool
    model_count: int
...
async def list_model_lists(
    ...
    try:
        ...
        # app_model_lists table is not provisioned on this deployment.
        logger.warning("app_model_lists table missing; returning empty model list set")
        return []
