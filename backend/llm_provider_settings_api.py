...
async def list_providers(_admin: Dict[str, Any] = Depends(require_admin_user)):
    """
...
async def list_available_provider_types(_admin: Dict[str, Any] = Depends(require_admin_user)):
    """
