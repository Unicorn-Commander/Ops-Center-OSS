...
async def list_byok_rules(
    ...
    async with db_pool.acquire() as conn:
        ...
        try:
            ...
            logger.warning("pricing_rules table missing; returning empty BYOK rules")
            rows = []
...
async def list_platform_rules(
    ...
    async with db_pool.acquire() as conn:
        ...
        try:
            ...
            logger.warning("pricing_rules table missing; returning empty platform rules")
            rows = []
...
async def list_credit_packages(
    ...
    async with db_pool.acquire() as conn:
        ...
        try:
            ...
            logger.warning("credit_packages table missing; returning empty packages")
            rows = []
