...
```bash
chmod 666 /home/deploy/Production/UC-1-Pro/services/ops-center/backend/data/ops_center.db
chmod 777 /home/deploy/Production/UC-1-Pro/services/ops-center/backend/data/
```
