...
# Admin-only analytics router. The default-deny middleware allowlists the /api/v1/llm/
# prefix (for m2m inference), so this router self-protects with a router-level dependency.
