...
async def require_admin(request: Request) -> bool:
    ...
    if user_role not in ("admin", "system_admin") and "admin" not in user_roles and "system_admin" not in user_roles and "admin" not in groups and not user.get("is_admin"):
