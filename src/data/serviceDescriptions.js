...
export const serviceDescriptions = {
  ...
  'open-webui': {
    ...
    url: 'https://chat.magicunicorn.dev',
  ...
  'unicorn-orator': {
    ...
    url: 'https://tts.magicunicorn.dev',
  ...
  'unicorn-amanuensis': {
    ...
    category: 'Voice Services',
    url: 'https://stt.magicunicorn.dev',
  ...
  'brigade': {
    ...
    url: 'https://brigade.magicunicorn.dev',
  ...
  'center-deep': {
    ...
    category: 'Search',
    url: 'https://search.magicunicorn.dev',
  ...
  'keycloak': {
    ...
    category: 'Security',
    url: 'https://auth.magicunicorn.dev',
    localUrl: 'http://localhost:8080',
    port: 8080,
    icon: 'vpn_key',
    status: 'operational',
  ...
  'lago': {
    ...
    category: 'Billing',
    url: 'https://billing.magicunicorn.dev',
