...
export const routes = {
  ...
  personal: {
    dashboard: {
      path: '/admin/',
      component: 'AdminRedirect', // role-based: admins → /admin/dashboard, users → /admin/my-dashboard
    ...
    subscription: {
      ...
      children: {
        ...
        // Dedicated change-plan flows (linked from Current Plan; hidden from nav)
        subscriptionUpgrade: {
        ...
        subscriptionDowngrade: {
          path: '/admin/subscription/downgrade',
    ...
    children: {
      peopleAccess: {
        ...
        children: {
          ...
          orgFeatures: {
            path: '/admin/people/org-features',
            component: 'OrgFeatures',
            roles: ['admin'],
            name: 'Org Feature Grants'
          }
        }
      },
      ...
      billingPlans: {
        ...
        children: {
          ...
          apps: {
            ...
            roles: ['admin'],
            name: 'App Catalog' // app-definition CRUD; tier↔app entitlements live on Subscription Tiers
          },
          pricing: {
          ...
          rates: {
            path: '/admin/billing/rates',
            component: 'PricingRates',
            roles: ['admin'],
            name: 'Rates & Margin'
          },
          revenue: {
          ...
          creditManagement: {
            // This is the user-facing Buy Credits checkout, not an admin credit console —
            // demoted from the admin nav (Credit Packs is the admin surface for packs).
          ...
          inferencePolicy: {
            path: '/admin/billing/inference-policy',
            component: 'AppModelPolicy',
            roles: ['admin'],
            name: 'Inference Policy' // included-vs-metered matrix; prices live on Rates & Margin
          },
          creditPacks: {
            path: '/admin/billing/credit-packs',
            component: 'CreditPackages',
            roles: ['admin'],
            name: 'Credit Packs'
          },
          agentPricing: {
            path: '/admin/billing/agent-pricing',
      ...
      aiModels: {
        ...
        children: {
          ...
          localModels: {
            ...
            roles: ['admin'],
            name: 'Model Servers' // read-only monitor of federated LLM services across the mesh
          },
          gpuServices: {
            path: '/admin/ai/gpu-services',
            component: 'GPUServicesManagement',
            roles: ['admin'],
            name: 'GPU Nodes' // read-only GPU compute-fabric inventory
          },
          ragServices: {
      ...
      infrastructure: {
        ...
        children: {
          ...
          vpnKeys: {
            path: '/admin/infra/network/vpn-keys',
            component: 'NetworkVPNKeys',
            roles: ['admin'],
            name: 'VPN Keys & Nodes',
          ...
          federationNodes: {
            path: '/admin/infra/federation/nodes',
            component: 'FederationNodes',
            roles: ['admin'],
            name: 'Federation Nodes',
            nav: false
          },
          federationContracts: {
            path: '/admin/infra/federation/contracts',
            component: 'FederationContracts',
            roles: ['admin'],
            name: 'Federation Contracts',
            icon: 'ShieldCheckIcon'
          },
          federationTopology: {
            path: '/admin/infra/federation/topology',
            component: 'FederationTopology',
            roles: ['admin'],
            name: 'Federation Topology',
            nav: false
          },
          federationServiceCatalog: {
            path: '/admin/infra/federation/services',
            component: 'FederationServiceCatalog',
            roles: ['admin'],
  ...
  // NOTE: this table is documentation — the implementation is the <Navigate>
  // routes in App.jsx. Keep both in sync when adding/removing a redirect.
  // ==========================================================================
  redirects: [
    ...
    { from: '/admin/system/billing', to: '/admin/billing/system', type: 'permanent' },
    { from: '/admin/billing/dashboard', to: '/admin/billing/revenue', type: 'permanent' },
    // NOTE: /admin/credits is a real page (CreditDashboard), not a redirect
    { from: '/admin/credits/purchase', to: '/admin/billing/credits/purchase', type: 'permanent' },
    ...
    { from: '/admin/system/analytics', to: '/admin/monitoring/analytics/advanced', type: 'permanent' },
    { from: '/admin/system/usage-analytics', to: '/admin/monitoring/usage-analytics', type: 'permanent' },
    { from: '/admin/system/usage-metrics', to: '/admin/monitoring/usage-metrics', type: 'permanent' },
...
function flattenRoutes(node, acc) {
  ...
  if (node.children) {
    ...
    // Namespace object (e.g. routes.personal, whose entries are direct
    // properties rather than a children map) — recurse over its values.
    // Without this, the whole personal section was invisible to
    // getAllRoutes()/getRouteByPath(), so personal pages never resolved
    // their titles or route metadata.
    Object.values(node).forEach(child => flattenRoutes(child, acc));
  }
  return acc;
}
