...
BRIGADE_API_URL=https://api.brigade.unicorncommander.ai
...
**Endpoint**: `https://unicorncommander.ai/api/v1/llm/chat/completions`
...
**Endpoint**: `https://api.brigade.unicorncommander.ai/api/agents/{id}/invoke`
...
**To change provider**:
1. Go to: https://unicorncommander.ai/admin/system/llm-providers
