...
curl -I https://unicorncommander.ai/admin/llm-provider-keys

# Test model catalog page
curl -I https://unicorncommander.ai/admin/llm-model-catalog

# Test routing page
curl -I https://unicorncommander.ai/admin/llm-routing

# Test analytics page
curl -I https://unicorncommander.ai/admin/llm-analytics
```
...
curl https://unicorncommander.ai/api/v1/features/unified_llm_hub
...
docker cp unicorn-postgresql:/tmp/pre_rollback_backup.dump \
  /opt/backups/pre_rollback_$(date +%Y%m%d_%H%M%S).dump
```
...
# Test old pages
curl https://unicorncommander.ai/admin/llm-provider-keys
curl https://unicorncommander.ai/admin/llm-model-catalog
...
curl http://staging.unicorncommander.ai/admin/llm-provider-keys
...
**Status Page**: status.unicorncommander.ai
