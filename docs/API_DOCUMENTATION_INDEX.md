...
- 🔄 Always up-to-date
- 📦 Includes Pydantic schemas
- 🛠️ Code generation ready
...
### v2.1.0 (October 2025)
- ✨ Added analytics endpoints (revenue, usage, user)
- ✨ Added BYOK (Bring Your Own Key) support
- ✨ Added bulk user operations
- ✨ Enhanced user detail pages
- 📝 Complete OpenAPI 3.0 documentation (310 endpoints)
...
### v1.0.0 (August 2025)
- ✨ Initial release
- ✨ User management via Keycloak SSO
- ✨ LLM inference proxy (LiteLLM)
- ✨ Service management
