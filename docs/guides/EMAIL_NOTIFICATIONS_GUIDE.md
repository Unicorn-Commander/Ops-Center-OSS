...
```python
{
    ...
    "dashboard_url": str,      # https://unicorncommander.ai
    "support_email": str,      # support@unicorncommander.ai
...
SMTP_PORT=587
SMTP_USERNAME=noreply@unicorncommander.ai
...
async def test():
    try:
        await aiosmtplib.send(
            ...
            port=587,
            start_tls=True,
            username='noreply@unicorncommander.ai',
