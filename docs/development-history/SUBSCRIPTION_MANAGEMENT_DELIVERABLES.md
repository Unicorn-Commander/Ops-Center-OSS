...
### Base URL
```
https://unicorncommander.ai/api/v1/subscriptions
```
...
checkout_data = create_upgrade_checkout_session(
    ...
    plan_code="professional",
    success_url="https://unicorncommander.ai/admin/subscription/success",
...
STRIPE_SUCCESS_URL=https://unicorncommander.ai/admin/subscription/success
STRIPE_CANCEL_URL=https://unicorncommander.ai/admin/subscription/plan?canceled=true
