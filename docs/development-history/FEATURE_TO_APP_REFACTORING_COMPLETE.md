...
1. **Navigate to App Management Page**:
   ```
   https://unicorncommander.ai/admin/system/app-management
   ```
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://unicorncommander.ai/api/v1/admin/apps/

# Test tier-apps endpoint
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://unicorncommander.ai/api/v1/admin/tiers/VIP_FOUNDER/apps
```
