...
```bash
cd /home/deploy/Production/UC-1-Pro/services/ops-center && ./deploy-keycloak-theme.sh
```
...
**Quick Deploy**: `cd /home/deploy/Production/UC-1-Pro/services/ops-center && ./deploy-keycloak-theme.sh`
