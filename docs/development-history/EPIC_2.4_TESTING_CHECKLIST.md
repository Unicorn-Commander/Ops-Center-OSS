...
**Steps**:
1. ✅ Navigate to https://unicorncommander.ai/admin/upgrade
...
**Steps**:
1. ✅ Navigate to https://unicorncommander.ai/admin/plans
...
- Webhook URL: https://unicorncommander.ai/api/v1/webhooks/stripe/checkout-completed
