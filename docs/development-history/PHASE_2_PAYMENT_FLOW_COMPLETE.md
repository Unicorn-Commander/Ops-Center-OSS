...
**URLs to Test**:
- Subscription Plans: https://unicorncommander.ai/admin/subscription/plan
- Success Page: https://unicorncommander.ai/admin/subscription/success
- Canceled Page: https://unicorncommander.ai/admin/subscription/plan?canceled=true

### Test Procedure

#### Test 1: Trial Plan Checkout

1. **Navigate to**: https://unicorncommander.ai/admin/subscription/plan
...
3. **Webhook URL**: `https://unicorncommander.ai/api/v1/billing/webhooks/stripe/checkout`
4. **Events to send**:
...
curl -X POST https://unicorncommander.ai/api/v1/billing/webhooks/stripe/checkout \
...
curl https://billing-api.unicorncommander.ai/api/v1/subscriptions \
