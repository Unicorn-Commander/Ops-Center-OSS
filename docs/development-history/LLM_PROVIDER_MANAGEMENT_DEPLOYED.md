...
**Primary URL**: `https://unicorncommander.ai/admin/system/llm-providers`
...
### 4. Test API Endpoint
```bash
curl -H "Cookie: session_token=..." https://unicorncommander.ai/api/v1/llm-config/health
```

**Expected**: Status 200 OK with health status

### 5. Access UI
1. Navigate to: `https://unicorncommander.ai/admin/system/llm-providers`
