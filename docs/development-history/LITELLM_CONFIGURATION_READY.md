...
**Location**: `/opt/ops-center/.env.litellm`
...
**Location**: `/opt/ops-center/LITELLM_SETUP_INSTRUCTIONS.md`
...
- ✅ Traefik labels for SSL (ai.unicorncommander.ai)
...
```
https://ai.unicorncommander.ai/v1/chat/completions
```
...
- **UC-Cloud Docs**: `/opt/uc-cloud/CLAUDE.md`
- **Ops-Center Docs**: `/opt/ops-center/CLAUDE.md`
