...
1. **Login to Ops-Center**: https://unicorncommander.ai/admin
...
**Via Ops-Center UI**:
1. Go to: https://unicorncommander.ai/admin/llm/providers
...
1. Go to: https://unicorncommander.ai/admin/llm/models
2. Click "Add Model"
...
**Via UI**:
1. Go to: https://unicorncommander.ai/admin/llm/routing
...
**View in Ops-Center**:
1. Go to: https://unicorncommander.ai/admin/llm/usage
...
echo "BYOK_ENCRYPTION_KEY=your-byok-encryption-key-here" >> \
