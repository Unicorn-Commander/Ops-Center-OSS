...
1. **UC API Keys** - User-generated keys for calling `api.unicorncommander.ai` from external systems
...
**File**: `/opt/ops-center/backend/uc_api_keys.py`
...
curl -X POST https://unicorncommander.ai/api/v1/account/uc-api-keys \
...
curl https://unicorncommander.ai/api/v1/account/uc-api-keys \
  -H "Cookie: session_token=YOUR_SESSION_TOKEN"
...
curl -X POST https://api.unicorncommander.ai/v1/chat/completions \
...
curl -X DELETE https://unicorncommander.ai/api/v1/account/uc-api-keys/uuid-here \
  -H "Cookie: session_token=YOUR_SESSION_TOKEN"
```
...
**File**: `/opt/ops-center/backend/platform_keys_api.py`
...
curl https://unicorncommander.ai/api/v1/admin/platform-keys \
...
curl -X PUT https://unicorncommander.ai/api/v1/admin/platform-keys/openrouter \
  -H "Cookie: session_token=ADMIN_SESSION_TOKEN" \
  -H "Content-Type: application/json" \
  -d '{
...
curl https://unicorncommander.ai/api/v1/admin/platform-keys/openrouter/decrypted \
  -H "Cookie: session_token=ADMIN_SESSION_TOKEN"
...
**File**: `/opt/ops-center/LITELLM_CONFIG_UPDATE.md`
...
API_KEY=$(curl -s -X GET https://unicorncommander.ai/api/v1/admin/platform-keys/openrouter/decrypted \
  -H "Cookie: session_token=$ADMIN_SESSION_TOKEN" | jq -r '.api_key')

# 2. Update .env.billing file
cd /opt/uc-cloud/billing
...
Steps:
1. User logs into unicorncommander.ai
...
3. Use in Postman:
   - URL: https://api.unicorncommander.ai/v1/chat/completions
...
**Production**:
- UC API Keys: https://unicorncommander.ai/api/v1/account/uc-api-keys
- Platform Keys: https://unicorncommander.ai/api/v1/admin/platform-keys
...
```bash
# Login as admin to unicorncommander.ai
