...
- URL: https://auth.unicorncommander.ai/realms/uchub
...
2. **SSO Endpoints Updated**:
   - All SSO buttons now redirect to: `https://auth.unicorncommander.ai/realms/uchub/...`
...
4. **Login settings**:
   - Root URL: `https://unicorncommander.ai`
   - Home URL: `https://unicorncommander.ai`
   - Valid redirect URIs:
     - `https://unicorncommander.ai/*`
     - `https://unicorncommander.ai/auth/callback`
   - Valid post logout redirect URIs: `https://unicorncommander.ai/*`
   - Web origins: `https://unicorncommander.ai`
   - Click **Save**
...
docker exec unicorn-keycloak /opt/keycloak/bin/kcadm.sh create clients -r uchub \
  ...
  -s 'redirectUris=["https://unicorncommander.ai/*","https://unicorncommander.ai/auth/callback"]' \
  -s 'webOrigins=["https://unicorncommander.ai"]' \
...
1. **Realm is Live**: The uchub realm is accessible and working at https://auth.unicorncommander.ai/realms/uchub
