...
4. **Keycloak Registration**
   ```
   https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/auth?
     client_id=ops-center&
     redirect_uri=https://unicorncommander.ai/signup-flow.html&
     response_type=code&
...
3. **POST /api/v1/billing/checkout/create**
   ...
   - Parameters:
     ...
     {
       "tier": "professional",
       "success_url": "https://unicorncommander.ai/billing/success",
       "cancel_url": "https://unicorncommander.ai/billing/canceled"
     }
     ```
