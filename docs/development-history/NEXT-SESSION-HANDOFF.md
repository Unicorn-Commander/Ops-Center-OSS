...
- Public URL: `https://unicorncommander.ai`
...
**Billing System:**
- Lago API: `https://billing-api.unicorncommander.ai`
- API Key: `your-lago-api-key`
- Integration: Working with Keycloak user management

### Backups Created 💾
- ops-center: `/opt/backups/ops-center-backup-20251013-215242.tar.gz` (27MB)
- Full UC-Cloud: `/opt/backups/uc-cloud-full-backup-20251013-215258.tar.gz` (64MB)
...
- **Lago Admin**: `https://billing-api.unicorncommander.ai`
  - API Key: `your-lago-api-key`
...
- `/home/deploy/CLAUDE.md` - Updated with current SSO config
...
### Lago Billing
- API URL: `https://billing-api.unicorncommander.ai`
- API Key: `your-lago-api-key`
