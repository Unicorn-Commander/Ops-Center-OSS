...
1. **Incorrect Token Endpoint URL**
   - Code was using: `https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/token`
...
2. **Incorrect Userinfo Endpoint URL**
   - Code was using: `https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/userinfo`
...
if "yoda.unicorncommander.ai" in str(request.url):
    userinfo_url = f"https://auth.yoda.unicorncommander.ai/realms/{keycloak_realm}/protocol/openid-connect/userinfo"
else:
...
- Removes legacy yoda.unicorncommander.ai check
...
```
Status: 200
Issuer: http://auth.unicorncommander.ai:8080/realms/uchub
Authorization Endpoint: http://auth.unicorncommander.ai:8080/realms/uchub/protocol/openid-connect/auth
Token Endpoint: http://auth.unicorncommander.ai:8080/realms/uchub/protocol/openid-connect/token
Userinfo Endpoint: http://auth.unicorncommander.ai:8080/realms/uchub/protocol/openid-connect/userinfo
```
...
Enabled: True
Redirect URIs: ['http://localhost:8000/auth/callback', 'https://unicorncommander.ai/auth/callback']
Web Origins: ['https://unicorncommander.ai', 'http://localhost:8000']
Public Client: False
...
User ID (sub): your-keycloak-user-id
...
**Redirect URIs**:
- `https://unicorncommander.ai/auth/callback` (production)
...
3. Ops-Center redirects to: https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/auth
4. Keycloak shows login form
5. User enters credentials
6. Keycloak redirects to: https://unicorncommander.ai/auth/callback?code=ABC123
...
3. Ops-Center redirects to: https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/auth?kc_idp_hint=google
4. Keycloak redirects to Google OAuth
5. User authenticates with Google
6. Google redirects back to Keycloak
7. Keycloak redirects to: https://unicorncommander.ai/auth/callback?code=ABC123
...
- ✅ **External URLs** (`https://auth.unicorncommander.ai`) - For browser redirects
...
Changes made to `/opt/ops-center/backend/server.py`
...
- [ ] Navigate to https://unicorncommander.ai
...
```bash
/opt/backups/ops-center-backup-20251013-215242.tar.gz
/opt/backups/uc-cloud-full-backup-20251013-215258.tar.gz
```
