...
1. **Manual Test Script**:
   ...
   curl -X POST https://unicorncommander.ai/api/v1/credits/purchase \
     -H "Content-Type: application/json" \
     -d '{
       "amount": 10.00,
...
1. **Lago API Key**: Configured and validated
   - `LAGO_API_KEY` present: `your-lago-api-key`
...
ab -n 1000 -c 10 https://unicorncommander.ai/api/v1/system/status
...
```bash
# OWASP ZAP scan
zap-cli quick-scan https://unicorncommander.ai

# SSL/TLS check
nmap --script ssl-enum-ciphers -p 443 unicorncommander.ai

# API security scan
nikto -h https://unicorncommander.ai/api/v1
```
...
# Lago
URL: https://billing-api.unicorncommander.ai
...
BYOK_ENCRYPTION_KEY=your-byok-encryption-key-here
```
...
**Report Location**: `/opt/ops-center/TEST_REPORT_INTEGRATION.md`
