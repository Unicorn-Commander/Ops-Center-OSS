...
**Location**: `/home/deploy/Production/UC-1-Pro/services/ops-center`
...
# Public Pages
$ curl https://unicorncommander.ai/plans.html
✅ HTTP 200 - Plans page loads

$ curl https://unicorncommander.ai/signup-flow.html
✅ HTTP 200 - Signup flow loads

$ curl https://unicorncommander.ai/billing-settings.html
...
3. Set URL: `https://unicorncommander.ai/api/v1/billing/webhooks/stripe`
4. Select events:
...
- **Billing API Reference**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/BILLING_API_QUICK_REFERENCE.md`
- **Stripe Integration Guide**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/STRIPE_INTEGRATION.md`
- **Lago Setup**: See main billing documentation in `/home/deploy/Production/UC-1-Pro/billing/`
