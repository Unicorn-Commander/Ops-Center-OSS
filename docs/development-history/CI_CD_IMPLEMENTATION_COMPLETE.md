...
- ✅ Container registry integration (git.unicorncommander.ai)
...
# Access services
# Prometheus: http://localhost:9090 or https://prometheus.unicorncommander.ai
# Grafana: http://localhost:3000 or https://grafana.unicorncommander.ai
...
**Access**:
- Grafana: https://grafana.unicorncommander.ai
- Prometheus: https://prometheus.unicorncommander.ai
...
2. Email (ops-team@unicorncommander.ai)
...
# Access Grafana
# https://grafana.unicorncommander.ai
...
# https://grafana.unicorncommander.ai (Deployment Dashboard)
```
...
# View metrics
# https://grafana.unicorncommander.ai
# https://prometheus.unicorncommander.ai
```
