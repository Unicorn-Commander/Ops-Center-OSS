...
1. **Login**: https://unicorncommander.ai/auth/login
...
### Direct URL
```
https://unicorncommander.ai/admin/infrastructure/cloudflare
```
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://unicorncommander.ai/api/v1/cloudflare/zones

# List records for zone
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://unicorncommander.ai/api/v1/cloudflare/zones/ZONE_ID/records
```
...
### Access URLs
- **Frontend**: https://unicorncommander.ai/admin/infrastructure/cloudflare
- **API Docs**: https://unicorncommander.ai/api/docs (if enabled)
...
- **Master Checklist**: `/opt/uc-cloud/MASTER_CHECKLIST.md` (Section 1.6)
