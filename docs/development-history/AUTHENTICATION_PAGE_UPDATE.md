...
```json
{
  "clients": [
    ...
    },
    {
      ...
      "enabled": true,
      "redirect_uris": [
        "https://api.brigade.unicorncommander.ai/api/auth/oidc/callback"
      ],
      "status": "active"
    }
  ],
...
- **Realm**: `uchub`
- **Admin URL**: `https://auth.unicorncommander.ai/admin/uchub/console`
...
2. **brigade**
   ...
   - Redirect: `https://api.brigade.unicorncommander.ai/api/auth/oidc/callback`
...
# Access UI
# Navigate to: https://unicorncommander.ai/admin/authentication
```
...
- **UC-Cloud Configuration**: `/opt/uc-cloud/CLAUDE.md`
