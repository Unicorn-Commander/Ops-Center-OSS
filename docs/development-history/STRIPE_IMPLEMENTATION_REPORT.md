...
- Keycloak admin: https://auth.unicorncommander.ai
...
- **Stripe Integration Docs**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/STRIPE_INTEGRATION.md`
- **Environment Template**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/.env.stripe.example`
- **Setup Script**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/setup_stripe_products.py`
- **API Code**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/stripe_api.py`
- **Integration Code**: `/home/deploy/Production/UC-1-Pro/services/ops-center/backend/stripe_integration.py`
