...
- URL: https://auth.unicorncommander.ai/admin
- Username: `admin`
...
4. Redirect URI: `https://auth.unicorncommander.ai/realms/master/broker/google/endpoint`
...
4. Redirect URI: `https://auth.unicorncommander.ai/realms/master/broker/github/endpoint`
...
4. Redirect URI: `https://auth.unicorncommander.ai/realms/master/broker/microsoft/endpoint`
