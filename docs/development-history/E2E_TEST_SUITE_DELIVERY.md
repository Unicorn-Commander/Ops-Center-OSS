...
**Location**: `/opt/ops-center/playwright.config.js`
**Lines**: 110
...
#### `.env.test.example`
**Location**: `/opt/ops-center/.env.test.example`
**Lines**: 20
...
**Location**: `/opt/ops-center/package.json`
...
**Location**: `/opt/ops-center/tests/e2e/ops-center.spec.js`
**Lines**: 800+
...
**Location**: `/opt/ops-center/tests/e2e/helpers/auth.js`
**Lines**: 110
...
**Location**: `/opt/ops-center/tests/e2e/helpers/api.js`
**Lines**: 150
...
**Location**: `/opt/ops-center/tests/e2e/helpers/accessibility.js`
**Lines**: 280
...
#### `tests/e2e/README.md`
**Location**: `/opt/ops-center/tests/e2e/README.md`
**Lines**: 500+
...
**Location**: `/opt/ops-center/tests/e2e/QUICK_START.md`
**Lines**: 120
...
**Location**: `/opt/ops-center/tests/e2e/TEST_SUITE_SUMMARY.md`
**Lines**: 600+
...
**Location**: `/opt/ops-center/.github/workflows/e2e-tests.yml`
**Lines**: 350+
