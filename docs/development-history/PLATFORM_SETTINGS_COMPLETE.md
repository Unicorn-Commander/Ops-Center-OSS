...
1. **Navigate to**: https://unicorncommander.ai/admin/platform/settings
...
5. **Paste**: New webhook secret (e.g., `whsec_your_webhook_secret`)
...
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://unicorncommander.ai/api/v1/platform/settings

# Get specific setting
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://unicorncommander.ai/api/v1/platform/settings/STRIPE_WEBHOOK_SECRET
...
curl -X POST \
  ...
  https://unicorncommander.ai/api/v1/platform/settings/test
```
...
**Current Value**: `whsec_your_webhook_secret`
...
# Output: whsec_your_webhook_secret
...
```
1. Visit https://unicorncommander.ai/admin/platform/settings
...
**GUI**:
```
https://unicorncommander.ai/admin/platform/settings
...
**Access**: https://unicorncommander.ai/admin/platform/settings
