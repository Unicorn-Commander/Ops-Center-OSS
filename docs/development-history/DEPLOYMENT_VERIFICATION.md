...
**Access**: https://unicorncommander.ai/extensions
...
**Access**: Click any add-on card OR https://unicorncommander.ai/extensions/{id}
...
**Steps**:
1. Login at: https://auth.unicorncommander.ai
2. Navigate to: https://unicorncommander.ai/extensions
...
**Access**: https://unicorncommander.ai/extensions/cart OR click cart icon
...
**After Payment**:
- [ ] Redirects to success page: https://unicorncommander.ai/extensions/success
...
**Access**: https://unicorncommander.ai/extensions/purchases
...
**Access**: https://unicorncommander.ai/admin/extensions
...
**Access**: https://unicorncommander.ai/admin/extensions/analytics
...
All endpoints accessible at: `http://localhost:8084` (internal) or `https://unicorncommander.ai` (public)
...
4. Cookie domain should be `.unicorncommander.ai`
...
ls -lh /opt/ops-center/public/assets/ | head
```
...
# Navigate to: https://auth.unicorncommander.ai/admin
...
**For Development**:
- Backend API: `/opt/ops-center/backend/`
- Frontend: `/opt/ops-center/src/`
- Database schema: `/opt/ops-center/backend/sql/`
