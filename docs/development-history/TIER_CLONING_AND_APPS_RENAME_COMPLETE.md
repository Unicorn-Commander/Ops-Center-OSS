...
**Example Request**:
```bash
curl -X POST "https://unicorncommander.ai/api/v1/admin/tiers/vip_founder/clone?new_tier_code=vip_founder_v2&new_tier_name=VIP%20Founder%20V2&price_monthly=0.00" \
...
1. Navigate to: https://unicorncommander.ai/admin/subscriptions
...
**Deployment**: Live on unicorncommander.ai
