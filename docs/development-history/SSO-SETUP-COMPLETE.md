...
- Verified realm is accessible at: `https://auth.unicorncommander.ai/realms/uchub`
...
### Keycloak URLs
- **Public URL**: `https://auth.unicorncommander.ai`
- **Internal URL** (from ops-center): `http://uchub-keycloak:8080`
- **Realm**: `uchub`

### OIDC Endpoints
- **Issuer**: `https://auth.unicorncommander.ai/realms/uchub`
- **Authorization**: `https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/auth`
- **Token**: `https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/token`
- **Userinfo**: `https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/userinfo`
- **Logout**: `https://auth.unicorncommander.ai/realms/uchub/protocol/openid-connect/logout`
...
1. Visit: `https://unicorncommander.ai/login.html`
...
1. Visit: `https://unicorncommander.ai/signup.html`
...
```bash
# Deploy custom theme
/opt/ops-center/deploy-keycloak-theme.sh
```
...
curl -s https://auth.unicorncommander.ai/realms/uchub/.well-known/openid-configuration | python3 -m json.tool
```
