...
**File**: `/opt/ops-center/backend/logs_search_api.py`
**Lines**: 487 lines
...
**File**: `/opt/ops-center/backend/tests/test_logs_search.py`
**Lines**: 533 lines
**Test Coverage**:
...
**File**: `/opt/ops-center/src/pages/Logs.jsx`
...
- URL: https://unicorncommander.ai/admin/logs
...
**File**: `/opt/ops-center/docs/LOGS_SEARCH_API.md`
...
```bash
# View documentation
cat /opt/ops-center/docs/LOGS_SEARCH_API.md
```
...
- **Access**: https://unicorncommander.ai/admin/logs → "Log History" tab
...
**Access**:
- Frontend: https://unicorncommander.ai/admin/logs → "Log History" tab
- API: POST https://unicorncommander.ai/api/v1/logs/search/advanced
