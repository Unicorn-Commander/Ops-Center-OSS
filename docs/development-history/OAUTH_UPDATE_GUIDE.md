...
```
Google:    https://auth.unicorncommander.ai/source/oauth/callback/google/
GitHub:    https://auth.unicorncommander.ai/source/oauth/callback/github/
Microsoft: https://auth.unicorncommander.ai/source/oauth/callback/microsoft/
```

**New (Custom) Callback:**
```
ALL: https://unicorncommander.ai/auth/callback
```
...
- Tenant ID: `your-ms365-tenant-id`
...
- [ ] Google: Added `https://unicorncommander.ai/auth/callback`
- [ ] GitHub: Updated to `https://unicorncommander.ai/auth/callback` (or created new app)
- [ ] Microsoft: Added `https://unicorncommander.ai/auth/callback`
...
4. After authorization, should redirect back to:
   ```
   https://unicorncommander.ai/auth/callback?code=...&state=...
   ```
