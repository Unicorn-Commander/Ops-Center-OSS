...
BASE_PATH = os.getenv('UC1_BASE_PATH', '/home/deploy/Production/UC-1-Pro')
...
```bash
UC1_BASE_PATH=/home/deploy/Production/UC-1-Pro
```
...
3. **Update Environment**
   ...
   echo "UC1_BASE_PATH=/home/deploy/Production/UC-1-Pro" >> .env
   ```
