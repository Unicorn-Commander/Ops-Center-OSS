...
**URL**: https://unicorncommander.ai/admin/credits/purchase (after frontend build)
...
# URL: https://unicorncommander.ai/api/v1/billing/credits/webhook
...
1. Navigate to: https://unicorncommander.ai/admin/system/subscription-management
...
**Generate a new code**:
```bash
curl -X POST https://unicorncommander.ai/api/v1/admin/invite-codes/generate \
...
**Validate a code**:
```bash
curl https://unicorncommander.ai/api/v1/invite-codes/validate/VIP-FOUNDER-EARLY100
```

**List all codes** (admin):
```bash
curl https://unicorncommander.ai/api/v1/admin/invite-codes/ \
  -H "Cookie: session_token=YOUR_SESSION"
```
...
### VIP Founder Tier
- [ ] Admin's account shows VIP Founder tier
...
All documentation is in `/opt/ops-center/`:
...
- ✅ Admin assigned to VIP Founder (done)
...
3. ✅ Admin assigned to VIP Founder - **DONE**
