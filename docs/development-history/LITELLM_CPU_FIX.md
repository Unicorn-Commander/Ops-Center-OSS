...
Create `/opt/ops-center/.env.litellm`:
```bash
...
- PostgreSQL init scripts: `/home/deploy/UC-1-Hub/scripts/create-multiple-postgres-databases.sh`
- LiteLLM config: `/opt/ops-center/docker-compose.litellm.yml`
- Ops-Center main config: `/opt/ops-center/.env.auth`
