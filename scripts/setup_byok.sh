...
if ! grep -q "^AUTHENTIK_BOOTSTRAP_TOKEN=" .env || grep -q "^AUTHENTIK_BOOTSTRAP_TOKEN=your-authentik-api-token-here" .env; then
    ...
    echo "1. Login to Authentik at https://auth.unicorncommander.ai"
...
echo "   https://unicorncommander.ai/settings/api-keys"
echo ""
echo "Documentation:"
echo "- API Reference: /home/deploy/Production/UC-1-Pro/docs/BYOK_API.md"
echo "- Implementation Guide: /home/deploy/Production/UC-1-Pro/docs/BYOK_IMPLEMENTATION.md"
echo ""
