...
if [ ! -f "backend/server_auth_integrated.py" ]; then
    ...
    echo "Please run this script from /home/deploy/Production/UC-1-Pro/services/ops-center"
    exit 1
fi
...
echo "   sqlite3 /home/deploy/Production/UC-1-Pro/volumes/ops_center.db"
