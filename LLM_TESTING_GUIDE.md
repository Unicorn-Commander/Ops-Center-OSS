...
**URL**: `https://unicorncommander.ai/admin/system/llm-providers`
...
1. **Navigate to LLM Providers page**
   ```
   https://unicorncommander.ai/admin/system/llm-providers
   ```
...
curl -X POST "https://unicorncommander.ai/api/v1/llm-config/api-keys/1/test" \
...
echo "BYOK_ENCRYPTION_KEY=$ENCRYPTION_KEY" >> /opt/ops-center/.env.auth
...
# Or check .env.auth
grep POSTGRES /opt/ops-center/.env.auth
```
...
if [ -f "/opt/ops-center/public/assets/LLMProviderSettings-BMmaRIT2.js" ]; then
...
echo "=== Test Complete ==="
echo ""
echo "Next: Login to https://unicorncommander.ai/admin/system/llm-providers"
