...
```
User at unicorncommander.ai
         │
         ├─ Click "Open-WebUI"
         │
         ▼
  Opens: chat.unicorncommander.ai
         │
         ├─ Keycloak session check
         │  (same domain .unicorncommander.ai)
         │
         ▼
  ✅ Auto-authenticated
...
User at unicorncommander.ai
  ...
  Opens: search.centerdeep.online  ← DIFFERENT DOMAIN!
         ...
         │  1. Redirect to auth.unicorncommander.ai
...
User at unicorncommander.ai
  ...
  Opens: awesome-tool.com/sso/unicorn  ← THIRD-PARTY!
         │
         ├─ Redirects to auth.unicorncommander.ai
         │
...
add_ons WHERE id = 17:
  ...
  launch_url: "https://search.unicorncommander.ai"  ← Can be ANY URL!
...
// Examples:
// chat.unicorncommander.ai → "UC Hosted" (blue)
...
User Login → Keycloak (uchub realm)
              ...
              └─ User navigates Ops-Center
                    ...
                    │     2. Redirect to auth.unicorncommander.ai
...
✅ Users access via https://unicorncommander.ai
```
...
Add third-party app:
    ...
    │   - Provider: unicorncommander.ai Keycloak
